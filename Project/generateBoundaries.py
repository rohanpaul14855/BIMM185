...
def genNegBoundaries(sizes, path):
    ...
    for cell in cells:
        ...
        for line in infile:
            ...
            identifier += 1
            tad = ['chr' + randTad[1]] + randTad[2:4] + ['id{}'.format(identifier)] +\
                  ['chr' + randTad[1]] + randTad[4:-1] + ['id{}'.format(identifier)]
...
genNegativeBoundaries(size_dict('data/looplist/'), 'data/looplist/')